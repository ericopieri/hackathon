<template>
    <div class="container-blur-garrafa">
    ...
    methods: {
        verificaRota() {
            if (!this.$route.params.id) {
                this.redirecionarGalao()
            } else {
                if (!(this.possibleGaloes.indexOf(this.$route.params.id) != -1)){
                    this.redirecionarGalao()
                }
            }
        },
        redirecionarGalao(rota = '/personalizacao/galao1') {
